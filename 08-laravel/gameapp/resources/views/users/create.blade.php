...
<section class="scroll">
    <figure class="avatar" >
        <img class="mask" id="profile-picture" src="../images/foto-portada.png" alt="Photo">
    ...
    <form action="{{ route ('users.store')}}" class="profile-form">
        <label for="name">Name</label>
        <input type="text" id="name" value="John Doe">
        
        <label for="name">Document</label>
        <input type="text" id="name" value="12345678">
